...
<Aside type="tip"> This usage documentation assumes you have already followed the [cli installation steps](/en/cli/installation). Below you will learn how to use the CLI with the `all-contributors` command, to keep things simple. If you are having any difficulties running the command on it's own, then give the `npx all-contributors-cli init` route a try 😺.</Aside>
