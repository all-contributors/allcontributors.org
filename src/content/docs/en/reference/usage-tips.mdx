---
title: Usage Tips
description: Best practices for project maintainers on when and how to add contributors promptly, alongside tips for encouraging contributors to self-register using the bot.
---

Learn how you can use the bot to maintain a healthy list of contributors. This guide includes all possible tipcs for repository maintainers to build up the community.
...
:::tip
If your project is configured for [the @all-contributors bot 🤖](/en/bot) simply write a comment on an issue or pull request to recognise their contribution. For example:
...
:::tip
It's a good idea to do so in the form of a pull request to make sure they're ok with being added.
:::
